/** Dialling codes, ISO 3166-1 alpha-2. Ordered alphabetically by country name. */
...
/** Shown above the full list — the markets this workspace sells into most. */
export const SUGGESTED_ISO = ['AE', 'SA', 'IN', 'GB', 'US'];
